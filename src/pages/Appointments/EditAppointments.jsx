  ...
  return (
    ...
    <div className="flex-grow-1">
          ...
          <div className='row main-heading'>
            <div className='col-md-6'><h3 className='block-title'>Edit Appointment</h3></div>
         ...
         <div className="dashboard-bg container-fluid py-4">
            <div className="form-container">
                <div className="form-title">Edit Appointment</div>
                ...
                {showAlerts && (
                    <div className="alert alert-success-custom d-flex justify-content-between align-items-center mb-2" role="alert">
                        <span>
                            <strong>Successfully Done!</strong> Appointment updated
                        </span>
